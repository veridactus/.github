...
1. **Draft** — Create a new file in `rfcs/` using the [RFC template](https://github.com/veridactus/docs/blob/main/rfcs/template.md).
2. **Submit** — Open a Pull Request with your RFC on [veridactus/docs](https://github.com/veridactus/docs).
...
6. **Final Vote** — TSC holds a final vote (see [GOVERNANCE.md](https://github.com/veridactus/docs/blob/main/GOVERNANCE.md) for thresholds).
7. **Merge** — Approved RFCs are merged and scheduled for the next version.

### Core Development

For contributions to the reference implementation, see the [veridactus/veridactus](https://github.com/veridactus/veridactus) repository.
...
- **Pass CI**: All validation checks must succeed.
